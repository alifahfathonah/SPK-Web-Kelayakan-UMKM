...
?>
			...
			{
 $z=mysql_fetch_array(mysql_query("select * from nilai where nik='$_GET[id]' and idsubkriteria='$y[0]'"));
			?>
                                      <tr>
                                        <td width="65%">(<?=$y[0]?>) <?=$y[2]?></td>
                                        <td width="35%"><?=$z[nilai]?></td>
                                      </tr>
                                      <? } ?>
                                    </table></td>
                                  </tr>
...
?>
                                ...
                                <br />
                                <br />
                                <div align="center"><a href="admin.php?page=editnilai&id=<?=$_GET[id]?>">Edit Nilai</a> || <a href="admin.php?page=penilaian">Kembali</a></div>
                                <p>&nbsp;</p>
                              </form></td>
                            </tr>
                            <tr>
