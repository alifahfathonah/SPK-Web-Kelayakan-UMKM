                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td colspan="3" align="center"><form action="editjenis1.php?id=<?=$_GET[id]?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0">
                               <?  $a=mysql_query("select * from jenis where idjenis='$_GET[id]'"); 
					  $b=mysql_fetch_array($a); ?>
                                  <tr>
                                    <td width="82"><div align="left">Jenis Usaha</div></td>
                                    <td width="16">:</td>
                                    <td width="418"><div align="left">
                                      <textarea name="a" rows="3" id="a"><?=$b[1]?></textarea>
                                    </div></td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
