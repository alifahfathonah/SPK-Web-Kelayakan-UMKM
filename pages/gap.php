                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td colspan="3" align="center"><form action="inputgap.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  ...
                                  <tr>
                                    ...
                                    <td>:</td>
                                    <td><div align="left">
                                      <input name="b" type="text" id="a3" value="" />
                                    </div></td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td width="418"><div align="left">
                                      <textarea name="c" rows="4" id="c"></textarea>
                                    </div></td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
