			...
			?> 
                        ...
                        <div class="panel-body">
                          <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td colspan="3" align="center"><form action="inputnilaisubkriteria.php?id=<?=$_GET[id]?>&id1=<?=$_GET[id1]?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
			...
			?>
                                  ...
                                  <tr>
                                    ...
                                    <td width="418"><div align="left">
                                      <textarea name="a" rows="4" id="a"></textarea>
                                    </div></td>
                                  </tr>
                                  <tr>
                            ...
                            <tr>
                              <td colspan="3" align="center"><table width="90%" border="1" align="center">
                                ...
                                <?php
						   $a=mysql_query("select * from subkriteria2 where idsubkriteria='$_GET[id1]' order by idsubkriteria2 asc"); 
					  $no=1;
