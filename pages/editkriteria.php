                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td colspan="3" align="center"><form action="editkriteria1.php?id=<?=$_GET[id]?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
			...
			?>
                                  ...
                                  <tr>
                                    ...
                                    <td width="418"><div align="left">
                                      <textarea name="b" rows="4" id="b"><?=$a[1]?></textarea>
                                    </div></td>
                                  </tr>
                                  <tr>
                                    <td>Bobot</td>
                                    <td>:</td>
                                    <td><div align="left">
                                      <input name="d" type="text" id="d" value="<?=$a[2]?>" />
                                    </div></td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
					  ...
					  ?>
                                <tr>
                                  ...
                                  <td><a href="admin.php?page=subkriteria&amp;id=<?php echo"$b[0]"; ?>" >Subkriteria</a> || <a href="admin.php?page=editkriteria&amp;id=<?php echo"$b[0]"; ?>" >Edit</a> || <a onclick="return confirm ('Anda yakin akan menghapus Data Ini ?')" href="hapuskriteria.php?id=<?php echo"$b[0]"; ?>" >Hapus</a></td>
                                </tr>
                                <?php
					  $no++;
					  }
